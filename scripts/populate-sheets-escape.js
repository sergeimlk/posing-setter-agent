...
async function main() {
  ...
  console.log("Waiting 8 seconds for Sheet interface...");
  await page.waitForTimeout(8000);

  // Press Escape to dismiss any Google Drive/Sign-In overlays
  console.log("Pressing Escape to dismiss overlays...");
  ...
  // Let's also check if we can rename the sheet tab
  ...
  // Double check if tab was renamed, if not try another method
