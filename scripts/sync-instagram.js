...
function writeFallbackData() {
  const prospects = [
    {
      ...
      "compDate": "Octobre 2026",
      "notes": "Athlète très prometteur. Rencontre des difficultés sur l'activation du vacuum et la transition arrière. Très intéressé par l'offre d'accompagnement de 3 mois.",
    ...
    },
    {
      ...
      "notes": "Cherche à perfectionner sa routine libre sur une musique personnalisée. A les moyens de s'offrir le coaching complet.",
    ...
    },
    {
      ...
      "notes": "Déjà convaincu de la valeur, en attente du lien de paiement ou d'un appel final pour confirmer le plan de financement en 3x.",
      "avatar": "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=150&h=150&fit=crop&crop=faces"
    },
    {
      "handle": "pierre_olivier_posing",
      "score": 78,
      "category": "principal",
      "hansStep": 3,
      "pertinence": 5,
      ...
      "compDate": "Octobre 2026",
      "notes": "Doit améliorer sa posture de face et son ouverture de dorsaux. Travaille actuellement avec un coach de diète généraliste qui ne gère pas le posing.",
    ...
    },
    {
      ...
      "categoryBody": "Classic Physique",
      "compDate": "Novembre 2026",
      "notes": "A répondu à la story de Manael sur le vacuum. Pose beaucoup de questions sur le contenu des séances hebdomadaires.",
    ...
    },
    {
      ...
      "notes": "Prospect chaud recommandé par un affilié. N'a jamais fait de posing encadré auparavant. Regarde beaucoup de vidéos YouTube.",
      "avatar": "https://images.unsplash.com/photo-1539571696357-5a69c17a67c6?w=150&h=150&fit=crop&crop=faces"
    },
    {
      "handle": "julien_posing",
      "score": 68,
      "category": "tiede",
      "hansStep": 3,
      "pertinence": 4,
      ...
      "categoryBody": "Men's Physique",
      "compDate": "Octobre 2026",
      "notes": "Semble indécis sur le budget mais comprend l'importance du posing pour ne pas gâcher ses efforts de sèche.",
  ...
  const finalData = {
    ...
    prospects,
    chatUsers: [
      { "handle": "lois_posing", "lastMessage": "Yes, je regarde ton planning et je prends le créneau Calendly de demain bro.", "time": "14:32" },
      { "handle": "livio_posing", "lastMessage": "Vocal envoyé de 45 secondes sur ma routine", "time": "13:15" },
      { "handle": "mael_posing", "lastMessage": "Ok nickel, envoie-moi le lien.", "time": "Hier" }
    ]
  };
