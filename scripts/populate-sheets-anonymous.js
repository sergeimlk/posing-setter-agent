...
async function main() {
  console.log("🚀 Launching anonymous Chromium instance...");
  // Playwright needs to find the local Chrome installation on Mac
  ...
  console.log("Navigating to public Google Sheets document...");
  await page.goto(SHEET_URL, { waitUntil: "load", timeout: 60000 });
  await page.waitForTimeout(8000); // Wait for Sheets to fully render
  ...
  const screenshotPath = "/Users/mily/.gemini/antigravity-ide/brain/8192c64f-e389-48d8-aaf4-66126c3082f2/sheet_populated_anon.png";
  await page.screenshot({ path: screenshotPath });
  console.log("Screenshot saved at:", screenshotPath);

  await browser.close();
  console.log("🎉 Google Sheets initialized and populated anonymously!");
}
